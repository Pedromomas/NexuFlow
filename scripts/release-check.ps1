...
$Version = '1.7.0'
$ReleaseName = "NexuFlow-$Version-InsightEdition"
...
$consumerFiles = @(
  'docs\INSTALL.md','docs\RELEASE_1.6.md','docs\RELEASE_1.6.1.md','docs\RELEASE_1.7.md','docs\COMPETITOR_REVIEW_1.7.md','docs\ANTI_CHEAT.md','docs\ANTICHEAT_RETEST.md',
